            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 sm:space-y-5 text-gray-200 slide-in-right text-enhanced">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <a href="mailto:pavan123.pk813@gmail.com" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors duration-300 text-sm sm:text-base break-all leading-relaxed">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <a href="tel:+919130455109" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors duration-300 text-sm sm:text-base leading-relaxed">
                    +91 9130455109
                  </a>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <span className="text-sm sm:text-base leading-relaxed">Goa, India</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 sm:space-y-5 text-gray-200 slide-in-right text-enhanced">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <a href="https://www.linkedin.com/in/pavan-kumar092" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors duration-300 text-sm sm:text-base leading-relaxed">
                    LinkedIn Profile
                  </a>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <a href="https://github.com/Pavan0989" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors duration-300 text-sm sm:text-base leading-relaxed">
                    GitHub Profile
                  </a>
                </div>
              </div>
