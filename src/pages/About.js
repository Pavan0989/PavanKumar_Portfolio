  ...
  return (
    <section id="about" className="flex flex-col items-center justify-center min-h-[70vh] py-20 px-4 fade-in">
      <div className="rounded-2xl shadow-2xl p-12 w-full max-w-5xl border border-zinc-700 glass-enhanced relative overflow-hidden">
        ...
        <h2 className="text-4xl font-bold mb-10 text-blue-100 slide-in-up z-10 relative text-enhanced">About Me</h2>
        
        {/* Personal Introduction Card */}
        <div className="bg-gradient-to-br from-zinc-800 via-zinc-900 to-black text-gray-100 shadow-xl rounded-2xl p-8 flex flex-col gap-4 border border-zinc-700 hover-lift hover-glow fade-in-scale relative overflow-hidden group mb-8">
          ...
          <div className="relative z-10">
            <h3 className="text-2xl font-bold text-blue-100 mb-6 slide-in-left text-enhanced">Personal Introduction</h3>
            <p className="text-xl text-gray-200 slide-in-right text-enhanced leading-relaxed">
        ...
        <div className="bg-gradient-to-br from-zinc-800 via-zinc-900 to-black text-gray-100 shadow-xl rounded-2xl p-8 flex flex-col gap-4 border border-zinc-700 hover-lift hover-glow fade-in-scale relative overflow-hidden group mb-8">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600/10 via-blue-600/10 to-cyan-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 shimmer"></div>
          <div className="relative z-10">
            <h3 className="text-2xl font-bold text-blue-100 mb-6 slide-in-left text-enhanced">Core Competencies</h3>
            <div className="grid gap-4 md:grid-cols-2 text-lg text-gray-200 slide-in-right text-enhanced">
              <div className="p-4 rounded-lg bg-zinc-700/50 border border-zinc-600">
                ...
                <p className="text-sm">HTML, CSS, JavaScript, React.js, Node.js, PHP, MySQL, SQL, Python (Basics)</p>
              </div>
              <div className="p-4 rounded-lg bg-zinc-700/50 border border-zinc-600">
                <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm">Full-Stack Web Development, REST API Integration, Backend and Frontend Structuring, Database Design and Management</p>
              </div>
              <div className="p-4 rounded-lg bg-zinc-700/50 border border-zinc-600">
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-purple-400 text-xl">🔧</span>
                  <span className="font-semibold text-white">DevOps & Security</span>
                </div>
                <p className="text-sm">Web Hosting, SSL Certificate Configuration, Basic Website Security</p>
              </div>
              <div className="p-4 rounded-lg bg-zinc-700/50 border border-zinc-600">
                <div className="flex items-center gap-3 mb-2">
                ...
                <p className="text-sm">Team Collaboration, Project Coordination, Analytical Thinking, and Problem Solving</p>
              </div>
            </div>
          </div>
          <div className="absolute top-4 right-4 w-12 h-12 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full opacity-20 float"></div>
        ...
        <div className="bg-gradient-to-br from-zinc-800 via-zinc-900 to-black text-gray-100 shadow-xl rounded-2xl p-8 flex flex-col gap-4 border border-zinc-700 hover-lift hover-glow fade-in-scale relative overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600/10 via-blue-600/10 to-cyan-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 shimmer"></div>
          <div className="relative z-10">
            <h3 className="text-2xl font-bold text-blue-100 mb-6 slide-in-left text-enhanced">Internship Experience</h3>
            <div className="p-6 rounded-lg bg-zinc-700/50 border border-zinc-600">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-yellow-400 text-2xl">🏢</span>
                <div>
                  <h4 className="text-xl font-semibold text-white">Full Stack Developer Intern</h4>
                  <p className="text-blue-400">Infotech Corporation of Goa</p>
                  <p className="text-gray-400 text-sm">July – August 2024</p>
                </div>
              </div>
